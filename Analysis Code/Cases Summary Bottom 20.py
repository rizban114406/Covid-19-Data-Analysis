...
treatmentCase = dataFromCsv['totalConfirmed'][-20:] - (dataFromCsv['totalDeaths'][-20:] + dataFromCsv['totalRecovered'][-20:])
print(treatmentCase)

ax1.barh(dataFromCsv['id'][-20:],dataFromCsv['totalDeaths'][-20:], label='Number of Death Cases', color='#8B0000', left = treatmentCase+ dataFromCsv['totalRecovered'][-20:])
ax1.barh(dataFromCsv['id'][-20:],dataFromCsv['totalRecovered'][-20:],left = treatmentCase, label='Number of Recovered Cases', color='#1E90FF')
ax1.barh(dataFromCsv['id'][-20:],treatmentCase[-20:], label='Number of Corona Cases', color='#CD5C5C')
